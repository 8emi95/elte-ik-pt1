...
public class AboutDialog extends JDialog implements ActionListener {
  ...
  private JLabel lbProgramnev = new JLabel("Kiss Editor",JLabel.CENTER);
  ...
  public AboutDialog(JFrame parent) {
    ...
    try {
      InputStream in = AboutDialog.class.getResourceAsStream("resources/about.properties");
    ...
    pnKep.add(new JLabel(new ImageIcon(getClass().getResource("resources/napoleonpenz.jpg"))));
